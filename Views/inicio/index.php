...
<head>
    ...
    <!-- site metas -->
    <title>Graduacion Infotep 2022</title>
...
<body class="main-layout">
    ...
    <div class="hottest">
        <div class="container-fluid">
            <div class="row d_flex">
                <div class="col-md-12">
                <h1 class="text-center" style="background-color:#13110e ;color:white;padding:10px;">Buscar Graduandos</h1>
                    <div class="titlepage">
    ...
    <script src="<?php echo RUTA; ?>public/app/inicio.js"></script>
</body>
